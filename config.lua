...
CreateThread(function()
    ...
    print([[
        ...
        ═══════════════════════════════════════════════════════════════════════════════
        🐺 VOICE RANGE SYSTEM - SUCCESSFULLY LOADED
        ═══════════════════════════════════════════════════════════════════════════════
        ...
        Voice Modes: ]] .. #Config.VoiceCycleOrder .. [[ configured (]] .. table.concat(Config.VoiceCycleOrder, ', ') .. [[)
        Default:     ]] .. Config.DefaultVoiceRange .. [[ mode
        
        Security:    ]] .. (Config.Security.EnableServerValidation and 'ENABLED ✓' or 'DISABLED ✗') .. [[
        Debug:       ]] .. (Config.Debug.EnableDebugPrints and 'ENABLED' or 'DISABLED') .. [[
